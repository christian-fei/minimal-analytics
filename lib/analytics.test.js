...
test.skip('calculate chart data (minutes)', t => {
  t.snapshot(analytics.calculateChartData(testData, 'minutes'))
})
test.skip('calculate chart data (hourly)', t => {
  t.snapshot(analytics.calculateChartData(testData, 'hourly'))
})
