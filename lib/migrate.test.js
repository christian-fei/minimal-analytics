...
const DATA_PATH = path.resolve(__dirname, '..', 'data', 'migrate.ljson')
...
test('fallback to utm_medium query param as referrer', async t => {
  addTestData([
    {
      r: null,
      p: '/posts/2020-03-02-First-steps-with-Darklang/?utm_medium=rss',
      w: 1799,
      v: '337747a42a',
      d: '2021-04-11T16:27:35.627Z'
    }
