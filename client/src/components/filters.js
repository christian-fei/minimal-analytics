    ...
    <div class='grid-lg contain'>
      <div class='w-50-lg'>
        ...
        <div>
          ...
          <span onClick={() => updateTimeframe('past-6-months')} class={`select-timeframe filterable ${filters.timeframe === 'past-6-months' && 'active'}`} name='past-6-months' id='past-6-months'>Past 6 months</span>
      ...
      <div class='w-50-lg'>
        ...
        {['past-week', 'past-month', 'past-6-months', 'past-year'].includes(filters.timeframe) && <span onClick={() => updateResolution('daily')} class={`select-resolution filterable ${filters.resolution === 'daily' && 'active'}`} name='daily' id='daily'>Daily</span>}
